...
export default function EndFooter() {
  return (
    <>
      <div className="offer_benner wow fadeInUp">
        <div className="container">
          <div className="offer_benner_wrapper">
          ...
          <div className="container">
            <div className="row">
              <div className="help_box col-md-4 col-sm-6 col-xs-12">
                <div className="help_detail_box">
                  <div className="contact_icon">
                    <img src={require("../images/phone.png")} alt="contact" />
                  </div>
                  <div className="help_detail">
                    <h6>FREE CONSULTATION</h6>
                    <h3>Schedule a free consultation with our specialist</h3>
              ...
              <div className="help_box col-md-4 col-sm-6 col-xs-12">
                <div className="help_detail_box">
                  <div className="contact_icon">
                    <img src={require("../images/request.png")} alt="request" />
                  </div>
                  <div className="help_detail help_request">
                    <h6>PROJECT REQUEST</h6>
                    <h3>Begin your adventure with experienced professionals</h3>
                    <div className="theme_btn">
                      <Link
                        onClick={() => {
                          const newWindow = window.open(
              ...
              <div className="help_box col-md-4 col-sm-6 col-xs-12">
                <div className="help_detail_box">
                  ...
                  <div className="help_detail help_desk">
                    <h6>HELP DECK</h6>
                    <h3>Do you have questions or more information? call now</h3>
              ...
              <div className="footer_category">
                ...
                <li>
                  <Link to="/services4">
                    ...
                    <span>Back-end Development &amp; Database Management </span>
                  </Link>
                </li>
                <li>
                  <Link to="/services5">
